...
public class EvolvedBasicStrategyCountingExceptionsInvers extends PlayerStrategy {
	public EvolvedBasicStrategyCountingExceptionsInvers(CardDeck deck) {
		super(deck, "EvolvedBasicStrategy with Exceptions Invers", true);
