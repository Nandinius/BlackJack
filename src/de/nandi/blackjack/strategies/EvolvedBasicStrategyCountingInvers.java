...
public class EvolvedBasicStrategyCountingInvers extends PlayerStrategy {
	public EvolvedBasicStrategyCountingInvers(CardDeck deck) {
		super(deck, "EvolvedBasicStrategy Invers", true);
