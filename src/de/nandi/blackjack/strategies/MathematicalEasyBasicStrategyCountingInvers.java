...
public class MathematicalEasyBasicStrategyCountingInvers extends PlayerStrategy {
	public MathematicalEasyBasicStrategyCountingInvers(CardDeck deck) {
		super(deck, "MathematicalEasyBasicStrategyInvers", true);
	}
