...
public class ThorpBasicStrategyNoCounting extends PlayerStrategy {
	public ThorpBasicStrategyNoCounting(CardDeck deck) {
		super(deck, "ThorpBasicStrategy no CC", true);
	}
